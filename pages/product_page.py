...
class ProductPage(BasePage):
    ...
    def check_number_items_in_the_basket(self, arg):
    ...
    def scroll_to_button(self) -> None:
        basket_button = self.browser.find_element(*self.TO_THE_BASKET_BUTTON)
        self.scroll_to_element(basket_button)
    ...
    def add_additional_ingredient(self, arg):
        ...
        price_additional = int(self.browser.find_elements(*self.ADDITIONAL_PRODUCT_INGRIDIENT_PRICE)[arg].text.split()[2][1::])
    ...
    def delete_additional_ingredient(self, arg):
